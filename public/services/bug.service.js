...
function query(filterBy = getDefaultFilter(), sortBy = getDefaultSort()) {
    const queryParams = `?title=${filterBy.title}&minSeverity=${filterBy.minSeverity}&pageIdx=${filterBy.pageIdx}&sortBy=${sortBy.sortByCat}&desc=${sortBy.desc}&pageSize=${filterBy.pageSize}`
